...
/**
 * Gets a list of all user data entries.
...
/**
 * Fetches all relationship entries.
...
/**
 * Manually adds an interaction record between two users.
...
/**
 * Generates new next-users entries for the specified user.
